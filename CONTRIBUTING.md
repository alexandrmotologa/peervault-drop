# Contributing to PeerVault Drop

Thank you for your interest in contributing to PeerVault Drop! We welcome contributions of all kinds, whether you are fixing a bug, improving documentation, or proposing new features.
...
1. **Fork the repository** and clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/peervault-drop.git
   cd peervault-drop
   ```
...
PeerVault Drop requires **Node.js 20+ LTS** and npm.
